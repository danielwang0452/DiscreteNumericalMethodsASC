...
from  poly.model.basic import rao_gumbel, gst_mover, exact, \
...
def categorical_repara(logits, temp, method='gumbel', alpha=1.0, model_ref=None):
    ...
    elif method == 'reinmax_v4':
        sample, qy = reinmax_v2(logits, model_ref, tau=temp, jacobian_method='reinmax_v4')
        return sample, qy
