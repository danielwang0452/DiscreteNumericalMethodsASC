hyperparameters = {  # lr, temp according to table 8 for VAE with 8x4 latents
    ...
    ('reinmax_v4', 32, 32): [0.0005, 1.0, 'RAdam'],
    ...
    ('reinmax_v4', 10, 30): [0.0005, 1.0, 'RAdam'],
    ...
    ('reinmax_v4', 24, 4): [0.0005, 1.0, 'RAdam'],
    ...
    ('reinmax_v4', 16, 12): [0.0005, 1.0, 'RAdam'],
    ...
    ('reinmax_v4', 64, 8): [0.0005, 1.0, 'RAdam'],
    ...
    ('reinmax_v4', 8, 4): [0.0005, 1.0, 'Adam'],
}